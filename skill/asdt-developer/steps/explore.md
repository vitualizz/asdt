...
**Soft reference (optional)**: if `researcher/handoff` was recalled by the inline knowledge-recall prelude, use it as framing context; when absent, proceed normally.
