...
En este tutorial vas a instalar ASDT y correr un pipeline completo PM → Arquitecto → Developer para una feature concreta: **agregar un formulario de contacto con validación**.
...
## Paso 3 — Pedirle a ASDT una recomendación de pipeline
...
## Paso 4 — Correr el Product Manager

```text
/asdt-pm "Agregar un formulario de contacto con validación"
```

El PM fija el alcance, escribe las historias de usuario y guarda un artefacto `pm/backlog-entry` en la base de conocimiento (ver [Base de conocimiento y memoria](/asdt/docs/memory-and-engram)).
