...
Runs the Researcher specialist only — the discovery specialist for fuzzy problems (divergent ideation, feasibility scan, discovery brief). Runs before the PM when the problem isn't yet well-defined.
